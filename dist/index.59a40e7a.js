                                                        ...
                                                        !$options.compareDates($data.compareDate, event.dateEnd) ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("li", _hoisted_18, [
                                                            event.link != "" ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("span", _hoisted_19, [
                                                                (0, _vue.createElementVNode)("a", {
                                                                    href: event.link,
                                                                    target: "_blank"
                                                                }, (0, _vue.toDisplayString)(event.name), 9 /* TEXT, PROPS */ , _hoisted_20)
                                                            ])) : ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("span", _hoisted_21, (0, _vue.toDisplayString)(event.name), 1 /* TEXT */ ))
                                        ...
                                        default: (0, _vue.withCtx)(()=>[
                                                ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($setup.events, (event)=>{
                                                    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("ul", {
                                                        ...
                                                        $options.compareDates($data.compareDate, event.dateEnd) ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("li", _hoisted_22, [
                                                            event.link != "" ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("span", _hoisted_23, [
                                                                (0, _vue.createElementVNode)("a", {
                                                                    href: event.link,
                                                                    target: "_blank"
                                                                }, (0, _vue.toDisplayString)(event.name), 9 /* TEXT, PROPS */ , _hoisted_24)
                                                            ])) : ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("span", _hoisted_25, (0, _vue.toDisplayString)(event.name), 1 /* TEXT */ ))
                                                        ])) : (0, _vue.createCommentVNode)("v-if", true)
                                                    ]);
                                                }), 128 /* KEYED_FRAGMENT */ ))
                                            ]),
