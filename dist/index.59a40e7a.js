...
function listEvents() {
    data.events.forEach((event)=>{
        ...
        if (daysPassed < 0) console.log(event.name + " ended " + Math.abs(daysPassed) + " days ago.");
            ...
            if (countdown < 0) eventsSection += fire + '<p class="font-bold">Ongoing!</p></div></section>';
            else if (countdown === 0) eventsSection += rocket + '<p class="font-bold">Today is the day!</p></div></section>';
...
},{"@formkit/tempo":"bPFbk","bd5103096a294280":"5LFKi","@supabase/supabase-js":"04ZJL"}],"bPFbk":[function(require,module,exports) {
// src/iso8601.ts
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aP7aF","8lRBv"], "8lRBv", "parcelRequire716c")
